...
function modal(id){
    $.getJSON(DABATASE_URL + '/database.json', function (data) {
        ...
        response += '<p class="justify pt-4 pb-3 description-large">' + projects[id].description_large + '<br>Link do repositório: <a href="' + projects[id].link + '">' + projects[id].link + '</a><br>Link online: <a href="' + projects[id].linkOnline + '" target="_blank">' + projects[id].linkOnline +'</a></p>';
